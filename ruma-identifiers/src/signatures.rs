...
pub type ServerSigningKeyId<K> = KeyId<SigningKeyAlgorithm, K>;

/// Algorithm + key name for homeserver signing keys.
pub type ServerSigningKeyId = ServerSigningKeyId<KeyNameBox>;

/// Algorithm + key name for device keys.
pub type DeviceSigningKeyId = ServerSigningKeyId<DeviceId>;

/// Map of key identifier to signature values.
pub type EntitySignatures<K> = BTreeMap<ServerSigningKeyId<K>, String>;
